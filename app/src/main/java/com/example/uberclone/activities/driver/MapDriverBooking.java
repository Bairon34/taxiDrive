...
import com.example.uberclone.activities.client.MapClientBooking;
...
public class MapDriverBooking extends AppCompatActivity implements OnMapReadyCallback {
                ...
                if (getApplicationContext() != null) {
                    ...
                    mMarker = mMap.addMarker(new MarkerOptions().position(
                            new LatLng(location.getLatitude(), location.getLongitude())
                                    ...
                                    .title("Tu posicion")
                                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.brand))
                    );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMapFragment = (MapFragment) getFragmentManager().findFragmentById(R.id.map_driver);
