...
public class MapClientBooking extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map_driver);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    if (status.equals("start")) {
                        ...
                        startActivity(new  Intent(MapClientBooking.this, MapClient.class));
                        finish();
                       // finishBooking();
                    }
                }
    ...
    private  void finishBooking(){
        ...
        intent.putExtra("idClient",mAuthProvider.getId());
